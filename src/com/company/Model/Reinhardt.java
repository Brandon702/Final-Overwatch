...
public class Reinhardt extends Hero {
    ...
    public Reinhardt() {
            ...
            super("Reinhardt \n", "Real Name: Reinhardt Wilhelm \n " +
                            ...
                            "Health: 300\n" +
                            "Armor: 200",
                    "Reinhardts' primary weapon is a Rocket Hammer\n" +
                            "Weapon type: Melee\n" +
                            "Damage Per Swing: 75 \n" +
                            "Max Range: 5 meters \n" +
                            "Casting time: 0.42 seconds(initial swing)",
                    "Reinhardts' E Ability is Firestrike \n" +
                            "Type: Projectile \n" +
                            "Damage per hit: 100 \n" +
                            ...
                            "Cooldown: 6 seconds \n" +
                            "Headshot damage: No",
                    "Reinhardts' Shift Ability is Charge \n" +
                            ...
                            "Cooldown: 10 seconds",
                    "Reinhardts' rightclick ability is Barrier \n" +
                            "Health: 1600 \n" +
                    ...
                    "Reinhardts' Q Ability (or Ultimate) is Earthshatter \n" +
                    ...
                    "Here are a few tips on how to play Reinhardt at a bigger level \n" +
                            "Tip 1: Reinhardts' Earthshatter is one of the best ults in the game and one of the best stuns in the game\n" +
                            ", but it is one of the most counterable. Any sort of shielding object (ex. Another Rein shield, Zarya bubble, \n" +
                            " or just the enviroment can stop your shatter. Aim away from shields, bubbles, and objects and try to get at least 2 people per shatter. \n" +
                            "Tip 2: Reinhardts' shield isn't just for you. Keep an eye on your teammates and where enemy damage is coming from to help your \n" +
                            "team either retreat to safety or take the objective by force.\n" +
                            "Tip 3: While using Reinhardts' Charge ability, don't charge into deep. The enemy has a free kill. Try to pick off either \n" +
